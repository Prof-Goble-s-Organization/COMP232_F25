package Sample.structures.objects;

import java.util.ArrayList;
import Sample.structures.objects.COMP132.MyArrayList;
...
public class COMP132vsJavaAPI {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Using the COMP132 version of MyArrayList: The 132 ArrayList stored its elements 
         * as type Object, which allowed the list to store any type of object. 
        ...
        list2.add("My First String");
        list2.add("My Second String");
        list2.add("And yet another string!");
        // list2.add(new Integer(42));                  // error!

        String str2 = list2.get(0);                    // no cast required
        System.out.println(String.format("Here is my first string: %s", str2));
        // Double dbl2 = list2.get(1);                 // error!
    }
}
