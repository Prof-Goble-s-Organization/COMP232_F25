...
public class ObjectBox {
    ...
    public static void main(String[] args) {
        ...
        obj.setValue(42);
        int my_int = (Integer) obj.getValue();
        System.out.println(String.format("new value = %d", my_int));

        // however, this can lead to runtime errors that the compiler cannot catch
        // Uncomment the following line to see a runtime error
        String str2 = (String) obj.getValue();
        System.out.println(String.format("new value = %s", str2));
    }
}
